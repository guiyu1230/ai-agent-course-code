...
const mcpClient = new MultiServerMCPClient({
    mcpServers: {
        'my-mcp-server': {
            command: "node",
            args: [
                "/Users/piziyu/Desktop/github/ai-agent-cource-code/tool-test/src/my-mcp-server.mjs"
            ]
        },
...
// await runAgentWithTools("北京南站附近的5个酒店，以及去的路线，路线规划生成文档保存到 /Users/piziyu/Desktop 的一个 md 文件");
